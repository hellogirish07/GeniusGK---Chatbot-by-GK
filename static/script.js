...
function hideSplashScreen() {
  ...
  setTimeout(() => {
    ...
    // Focus on input and start idle timer
...
function hide() {
  ...
  let sidebarOpenBtn = document.getElementById('sidebar-open-btn');

  // If the open button doesn't exist, create it and append to body
  if (!sidebarOpenBtn) {
    sidebarOpenBtn = document.createElement('button');
    sidebarOpenBtn.id = 'sidebar-open-btn';
    sidebarOpenBtn.className = 'sidebar-open-btn';
    sidebarOpenBtn.title = 'Open sidebar';
    sidebarOpenBtn.setAttribute('aria-label', 'Open sidebar');
    sidebarOpenBtn.innerHTML = '<i class="fas fa-bars"></i>';
    sidebarOpenBtn.style.display = 'none';
    document.body.appendChild(sidebarOpenBtn);
  }

  if (!sidebar || !sidebarCloseBtn || !sidebarOpenBtn) return;

  function setOpenBtnVisibility() {
  ...
  sidebarCloseBtn.onclick = null;
  sidebarOpenBtn.onclick = null;

  sidebarCloseBtn.onclick = function () {
    sidebar.classList.add('collapsed');
    setOpenBtnVisibility();
  };
...
// Call hide() on page load to set up sidebar logic
